          ...
          {[
            ...
            <GlowCard key={name} glow="#FF4400">
              ...
              <div className="flex items-center justify-center h-28">
                <div className="w-20 h-20 rounded-md bg-white/[0.02]" style={{ boxShadow: shadow, border: `1px solid ${border}` }} />
              </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <GlowCard glow="#00D26A">
            <div className="h-24 rounded-md bg-[#FF4400]/10 relative overflow-hidden mb-3">
