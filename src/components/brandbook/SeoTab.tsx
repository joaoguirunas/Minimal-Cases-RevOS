    ...
    <div className="space-y-32">
      ...
      <section>
        ...
        <GlowCard glow="#FF4400">
          <div className="rounded-md bg-[#050505] border border-white/[0.06] p-5 font-mono text-[10px] space-y-2">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <GlowCard glow="#3B82F6">
            ...
            <div className="rounded-md bg-[#050505] border border-white/[0.06] p-4 font-mono text-[10px] space-y-1.5">
      ...
      <section>
        ...
        <GlowCard glow="#00D26A">
          ...
          <div className="rounded-md bg-[#050505] border border-white/[0.06] p-5 font-mono text-[10px] leading-relaxed">
