        ...
        <GlowCard glow="#FF4400">
          <div className="rounded-md border border-white/[0.06] overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              <div className="h-12 rounded-md bg-white/[0.02] border border-white/[0.04] flex items-center px-3">
                <span className="text-[8px] font-mono text-white/15">Section Divider</span>
              </div>
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3].map((n) => (
                  <div key={n} className="h-20 rounded-md bg-white/[0.02] border border-white/[0.04] flex items-center justify-center">
      ...
      <section>
        ...
        <GlowCard glow="#00D26A">
          ...
          <div className="grid gap-4" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
            {[1, 2, 3, 4, 5, 6].map((n) => (
              <div key={n} className="h-24 rounded-md bg-white/[0.02] border border-white/[0.04] flex items-center justify-center">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <GlowCard glow="#F59E0B">
            ...
            <div className="grid grid-cols-3 gap-px bg-[#FF4400]/20 rounded-md overflow-hidden">
              {[1, 2, 3, 4, 5, 6].map((n) => (
                <div key={n} className="h-16 bg-[#0a0a0a] flex items-center justify-center">
