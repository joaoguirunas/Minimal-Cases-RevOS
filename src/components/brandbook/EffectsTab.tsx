        ...
        <GlowCard glow="#3B82F6">
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span key={label} className="px-3 py-1 rounded-md text-[10px] font-mono font-medium uppercase tracking-wider" style={{ backgroundColor: bg, border: `1px solid ${border}`, color }}>
                {label}
              </span>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <GlowCard glow="#FF4400">
            ...
            <div className="flex items-center justify-center h-32">
              <div className="w-20 h-20 rounded-md border border-[#FF4400]/40 flex items-center justify-center animate-pulse" style={{ boxShadow: '0 0 30px rgba(255,68,0,0.4), 0 0 60px rgba(255,68,0,0.15)' }}>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={title}
              className="p-5 rounded-md border border-white/[0.06] bg-white/[0.02] cursor-pointer transition-all duration-300 hover:scale-[1.03] hover:bg-white/[0.04]"
              style={{ ['--hover-color' as string]: color }}
            >
              <div className="w-8 h-8 rounded-md mb-3 flex items-center justify-center" style={{ backgroundColor: `${color}12`, border: `1px solid ${color}20` }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <GlowCard key={name} glow="#F59E0B">
              <div className="relative h-24 rounded-md bg-gradient-to-br from-[#FF4400]/10 to-[#3B82F6]/10 overflow-hidden mb-3">
