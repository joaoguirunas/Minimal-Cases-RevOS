    ...
    <div className="space-y-32">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <GlowCard glow="#3B82F6">
            ...
            <div className="p-4 rounded-md bg-white/[0.03] border border-white/[0.06] shadow-lg shadow-black/20">
          ...
          <GlowCard glow="#00D26A">
            ...
            <div className="p-4 rounded-md bg-transparent border border-white/[0.10]">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <GlowCard glow="#FF4400">
            <div className="p-5 rounded-md bg-white/[0.02] border border-white/[0.06]">
              <div className="flex items-start justify-between mb-4">
                ...
                <Badge className="bg-[#00D26A]/10 text-[#00D26A] border-[#00D26A]/20 text-[9px] rounded-md">Active</Badge>
              </div>
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" className="h-[26px] rounded-md text-[9px]">Open</Button>
                <Button variant="ghost" size="sm" className="h-[26px] rounded-md text-[9px] text-white/30">
          ...
          <GlowCard glow="#F59E0B">
            <div className="p-5 rounded-md bg-white/[0.02] border border-white/[0.06]">
              <div className="flex items-start justify-between mb-4">
                ...
                <Badge className="bg-[#F59E0B]/10 text-[#F59E0B] border-[#F59E0B]/20 text-[9px] rounded-md">Draft</Badge>
              </div>
              <p className="text-[10px] text-white/25 mb-4">Last edited 2 hours ago · 3 collaborators</p>
              <div className="flex gap-2">
                <Button variant="outline" size="sm" className="h-[26px] rounded-md text-[9px]">
                  <Pencil className="w-3 h-3 mr-1" /> Edit
                </Button>
                <Button variant="ghost" size="sm" className="h-[26px] rounded-md text-[9px] text-rose-400/50">
          ...
          {[
            ...
            <GlowCard key={name} glow={color}>
              ...
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" className="h-[22px] rounded-md text-[8px]">
