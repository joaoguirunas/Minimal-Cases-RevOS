-- Fix the get_dashboard_negocios_aggregated function
...
CREATE OR REPLACE FUNCTION get_dashboard_negocios_aggregated(
  ...
  p_data_inicio timestamp without time zone DEFAULT NULL,
  p_data_fim timestamp without time zone DEFAULT NULL,
