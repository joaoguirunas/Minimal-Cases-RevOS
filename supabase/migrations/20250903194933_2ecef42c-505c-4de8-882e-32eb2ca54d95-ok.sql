-- Correção de nomenclatura - apenas adicionar políticas RLS para crm_usuario_times
-- (sem tentar remover políticas de tabelas inexistentes)

-- Criar políticas RLS para crm_usuario_times (tabela que realmente existe)
