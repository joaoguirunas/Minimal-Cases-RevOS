-- Rollback for: 20260501130000_fix_save_agent_complete_resolve_created_by.sql
-- Tested-against: pg15
-- Reverts the RPC body to the previous version (20260501120000_fix_save_agent_complete_array_types.sql)
-- by re-defining save_agent_complete without the defensive created_by resolution.
