-- Corrigir funções restantes com search_path mutable sem quebrar dependências

-- Atualizar apenas as funções que podem ser alteradas sem dependencies
...
-- Para handle_updated_at, apenas atualizar sem dropar (CREATE OR REPLACE)
