...
-- Adicionar coluna agencia_id na tabela de usuários globais
ALTER TABLE public.crm_usuarios_globais 
...
CREATE INDEX idx_crm_usuarios_globais_agencia_id ON public.crm_usuarios_globais(agencia_id);
...
USING (
  ...
  OR EXISTS (
    SELECT 1 FROM public.crm_usuarios_globais 
