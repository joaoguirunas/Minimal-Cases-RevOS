-- 1. CORRIGIR O TRIGGER DE DEDUPLICAÇÃO
-- Substituir o trigger atual por um mais robusto que ignora usuario_id
DROP TRIGGER IF EXISTS prevent_message_duplicates_trigger ON crm_messages;
...
-- 2. LIMPEZA DE DUPLICATAS EXISTENTES
...
-- 3. ADICIONAR FUNÇÃO DE MONITORAMENTO
