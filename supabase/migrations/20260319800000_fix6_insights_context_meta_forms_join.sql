-- Fix get_insights_context: meta_forms_stats CTE used l.metadata->>'meta_form_id'
-- but leads table has NO metadata column. Correct path:
-- meta_lead_forms → form_pro_submissions (via meta_form_id) → leads (via lead_id)
