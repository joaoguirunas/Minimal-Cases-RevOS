-- CORREÇÃO DO PERFIL DA RAFAELA E MELHORIA NA FUNÇÃO get_user_available_tenants
-- ========================================================================

-- 1. CORRIGIR PERFIL DA RAFAELA
UPDATE crm_usuarios 
SET 
  gestor = true,
...
-- 2. ATUALIZAR A FUNÇÃO get_user_available_tenants PARA SER MAIS ROBUSTA
...
SELECT 
  ...
  nome, email, gestor, super_adm, tenant_id
FROM crm_usuarios 
WHERE auth_user_id = '77234261-18b8-497b-adee-172124ebc4f9'::uuid;